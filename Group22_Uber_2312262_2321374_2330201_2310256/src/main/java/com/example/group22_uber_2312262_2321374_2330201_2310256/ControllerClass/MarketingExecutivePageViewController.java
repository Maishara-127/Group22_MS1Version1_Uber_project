...
public class MarketingExecutivePageViewController {
    ...
    public void TrackPerformanceMarketingCampaignButtonOnAction(ActionEvent event) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/group22_uber_2312262_2321374_2330201_2310256/trackPerformanceOfMarketingCampaignView.fxml"));
            Stage stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
